...
export default function ExtensionKitApp() {
  return (
...
const ExtensionKitPage: React.FC = () => {
  ...
  const product = { name: 'Extension Kit', price: 79.99 };

  const thumbnails = [
    { src: '/images/LL Box.png', alt: 'Extension kit box' },
  ];
  ...
  const handleAddToCart = async () => {
    setLoading(true);
    try {
      // Using the extension kit variant ID
      await addToCart('gid://shopify/ProductVariant/123456790', quantity);
      setAdded(true);
    ...
    <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 pt-24 bg-gray-50 min-h-screen">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
        ...
        <div className="space-y-6">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Extension Kit</h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center border rounded-lg">
              <button 
                className="px-3 py-1 text-lg bg-electric-aqua text-white hover:bg-opacity-90"
      ...
      <section className="py-12 md:py-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">How Extension Works</h2>
          <p className="text-lg text-gray-600 mt-2">Expanding your existing setup is as simple as connecting a new strand.</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="relative">
            <div className="aspect-video bg-gray-900 rounded-lg overflow-hidden shadow-xl">
              <iframe
                ...
                title="Extension Kit Installation Demo"
          ...
          <div className="space-y-6">
            {[
              { step: 1, title: 'Find connection point', description: 'Locate any bulb socket on your existing Linkin Lights setup.' },
              { step: 2, title: 'Remove existing bulb', description: 'Simply unscrew the bulb from the socket you want to extend from.' }
            ].map((item) => (
