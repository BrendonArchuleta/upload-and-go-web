...
//================================================================================
export default function OutdoorLightingApp() {
  return (
...
//================================================================================
// Outdoor Lighting Page Component
//================================================================================
const OutdoorLightingPage: React.FC = () => {
    const handleImageError = (e: React.SyntheticEvent<HTMLImageElement, Event>) => {
        const target = e.target as HTMLImageElement;
        target.onerror = null;
        target.src = `https://placehold.co/1260x750/0A192F/F0EAD6?text=Garden+Oasis`;
    };

    const outdoorBenefits = [
        { icon: <Star className="w-10 h-10"/>, title: "Boost Curb Appeal", description: "Elevate your home's beauty and value with Link'n Lights, highlighting every feature with a warm, inviting glow." },
        { icon: <Shield className="w-10 h-10"/>, title: "Durable & Weatherproof", description: "Built to last, Link'n Lights shine through rain, wind, and snow with an IP44 rating you can trust." },
        { icon: <Zap className="w-10 h-10"/>, title: "Effortless Installation", description: "Get a polished look in minutes. Link'n Lights need no electricians and no complicated wiring." }
    ];
        ...
        <main>
            ...
            <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-12">
                <div className="absolute inset-0">
                    <img src="https://images.pexels.com/photos/4112236/pexels-photo-4112236.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Elegant patio with warm string lights at night" className="w-full h-full object-cover"/>
                    <div className="absolute inset-0 bg-gradient-to-t from-midnight-navy via-midnight-navy/80 to-transparent"></div>
                </div>
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
                    <h1 className="text-4xl sm:text-7xl font-poppins font-bold text-white text-shadow-md mb-6 leading-tight animate-fade-up">
                        Your Outdoor Oasis, <span className="text-yellow-300">Perfectly Lit</span>
                    </h1>
                    <p className="text-lg text-white text-shadow-md font-inter max-w-3xl mx-auto mb-8 animate-fade-up" style={{ animationDelay: '200ms' }}>
                        Design your escape with Link'n Lights. Easy to connect, they make every space feel warm and inviting.
                    </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                     <div className="text-center mb-16">
                        <h2 className="text-4xl sm:text-5xl font-poppins font-bold text-warm-white mb-6">
                            Create an Evening Escape
                        </h2>
                        <p className="text-lg text-dark-text font-inter max-w-3xl mx-auto">
                            From celebrations to simple evenings, enjoy the warm ambiance that makes every night feel just right.
                        </p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8 text-center">
                        {outdoorBenefits.map((benefit, index) => (
    ...
    <section className="py-24 bg-dark-bg">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-dark-text font-inter max-w-2xl mx-auto">Use the slider to see the dramatic difference outdoor lighting makes.</p>
        </div>
        <div ref={containerRef} className="relative w-full aspect-video mx-auto rounded-2xl overflow-hidden cursor-ew-resize select-none" onMouseMove={handleMouseMove} onTouchMove={handleTouchMove}>
          <img src="/ChatGPT Image Sep 16, 2025, 04_47_00 PM.png" alt="Outdoor space after lighting" className="absolute inset-0 w-full h-full object-cover"/>
          <img src="/images/ChatGPT Image Sep 16, 2025, 04_47_00 PM.png" alt="Outdoor space after lighting" className="absolute inset-0 w-full h-full object-cover"/>
          <div className="absolute inset-0 w-full h-full object-cover overflow-hidden" style={{ clipPath: `inset(0 ${100 - sliderPosition}% 0 0)` }}>
            <img src="/images/ChatGPT Image Sep 16, 2025, 04_43_01 PM.png" alt="Outdoor space before lighting" className="absolute inset-0 w-full h-full object-cover"/>
          </div>
